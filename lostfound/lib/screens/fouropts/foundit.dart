...
class foundit extends StatefulWidget {
  final String lostname;
  final String email;

  foundit(this.lostname, this.email);

  @override
  State<foundit> createState() => _founditState();
}

class _founditState extends State<foundit> {
  Future MailFeedback(namelost, namefound, phone, message, toemail) async {
    final service_id = 'service_3xeoz18';
    final template_id = 'template_f0cdwh3';
